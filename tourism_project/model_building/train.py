...
Xtrain_path = hf_hub_download("SilviaMartin/Visitwithus", "Xtrain.csv", repo_type="dataset",force_download=True)
Xtest_path = hf_hub_download("SilviaMartin/Visitwithus", "Xtest.csv", repo_type="dataset",force_download=True)
ytrain_path = hf_hub_download("SilviaMartin/Visitwithus", "ytrain.csv", repo_type="dataset",force_download=True)
ytest_path = hf_hub_download("SilviaMartin/Visitwithus", "ytest.csv", repo_type="dataset",force_download=True)
...
# List of numerical features in the dataset
numeric_features = [
    'Age',            # Number of years the customer has been with the bank
...
categorical_features = [
    'TypeofContact', 'Occupation','Gender','ProductPitched','MaritalStatus', 'Designation'       # Country where the customer resides
]
...
with mlflow.start_run():
    ...
    model_path = "visit_with_us_model_v1.joblib"
    ...
    api.upload_file(
        path_or_fileobj="visit_with_us_model_v1.joblib",
        path_in_repo="visit_with_us_model_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
